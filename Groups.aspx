<%@ Page Title="Dash" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Groups.aspx.cs" Inherits="Dash.Groups" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <FilteringSettings ShowSearchUI="true" EditorNullTextDisplayMode="Unfocused" />
                ...
                <div class="action-buttons">
                    ...
                    <dx:BootstrapButton runat="server" ID="DeleteGroup" UseSubmitBehavior="False" Text="Pobriši"  OnClick="DeleteGroup_Click" CssClasses-Control="actionButton">
