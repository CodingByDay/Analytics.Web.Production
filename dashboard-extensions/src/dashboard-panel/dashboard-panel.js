...
var CustomDashboardPanelExtension = /** @class */ (function () {
    function CustomDashboardPanelExtension(_dashboardControl, options) {
        ...
        var toViewerItem = new designer_1.DashboardToolbarItem("toviewer", function () { return _this.switchToViewer(); });
    ...
    CustomDashboardPanelExtension.prototype.updateDashboardsList = function () {
        ...
        this._dashboardControl.requestDashboardList().done(function (availableDashboards) {
            _this.availableDashboards(availableDashboards.map(function (dashboard) { return new PanelExtensionDashboardInfo(dashboard.id, dashboard.name, options.dashboardThumbnail ? options.dashboardThumbnail.replace('{0}', dashboard.id) : undefined); }));
...
var PanelExtensionDashboardInfo = /** @class */ (function () {
